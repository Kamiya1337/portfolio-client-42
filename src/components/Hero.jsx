      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-9">
            <h1 className="max-w-5xl text-[2.55rem] font-black leading-[0.92] tracking-[-0.06em] text-charcoal sm:text-[clamp(3rem,5.5vw,6.5rem)] sm:leading-[0.9] sm:tracking-[-0.065em]">
          ...
          <aside className="border border-border-light bg-paper p-4 lg:col-span-3 lg:self-end">
            <img
              ...
              alt="Nguyễn Phương Thảo portfolio owner"
